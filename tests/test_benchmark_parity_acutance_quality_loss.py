...
class BenchmarkParityAcutanceQualityLossTest(unittest.TestCase):
    ...
    def test_reported_mtf_disconnect_scope_preserves_issue93_acutance_topology(self) -> None:
        capture_key = "OV13b10_AG8_ET5500_deadleaf_12M_40"
        preset_names = (
            '5.5" Phone Display Acutance',
            "Computer Monitor Acutance",
    ...
    def test_intrinsic_scope_can_keep_downstream_matched_ori_without_main_branch_reopen(self) -> None:
        capture_key = "OV13b10_AG8_ET5500_deadleaf_12M_40"
        preset_names = [
            '5.5" Phone Display Acutance',
            "Computer Monitor Acutance",
    ...
    def test_intrinsic_scope_can_reconnect_readout_and_keep_quality_loss_isolated(self) -> None:
        capture_key = "OV13b10_AG8_ET5500_deadleaf_12M_40"
        preset_names = (
            '5.5" Phone Display Acutance',
            "Computer Monitor Acutance",
    ...
    def test_intrinsic_scope_can_graft_pr30_bundle_to_quality_loss_without_main_acutance(self) -> None:
        capture_key = "OV13b10_AG8_ET5500_deadleaf_12M_40"
        preset_names = [
            '5.5" Phone Display Acutance',
            "Computer Monitor Acutance",
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                ...
                patch(
                    "algo.benchmark_parity_acutance_quality_loss.estimate_texture_support_scale",

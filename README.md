...
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_outer_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_outer_followup.md)
  - issue `#29` 的第四十三個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往外探到 `0.995` 後，確認它依然持續單調改善，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_rollover_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_rollover_followup.md)
  - issue `#29` 的第四十四個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.985` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_deeper_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_deeper_followup.md)
  - issue `#29` 的第四十五個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.975` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_further_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_further_followup.md)
  - issue `#29` 的第四十六個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.965` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_even_further_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_even_further_followup.md)
  - issue `#29` 的第四十七個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.955` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest_followup.md)
  - issue `#29` 的第四十八個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.945` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest2_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest2_followup.md)
...
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest5_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest5_followup.md)
  - issue `#29` 的第五十二個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.905` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
- [docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest6_followup.md](docs/imatest_parity_reference_anchor_acutance_curve_midclip_deepest6_followup.md)
  - issue `#29` 的第五十三個 upstream Acutance follow-up，將同一個 curve-side mid-scale notch family 再往下探到 `0.895` 後，確認它依然持續單調改善，尚未出現 rollover，並再次更新目前 best branch
